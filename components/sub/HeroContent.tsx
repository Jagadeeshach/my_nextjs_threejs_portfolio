...
const HeroContent = () => {
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center mb-[10px] text-start" >
        <motion.div 
        ...
        <motion.div
        variants={ slideInFromLeft(0.5) } className="flex flex-col gap-6 mt-6 text-5xl font-bold text-white max-w-[600px] w-auto h-auto">
